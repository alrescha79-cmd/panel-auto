...
if userdel -f $user 2>/dev/null; then
    ...
    delete_message="
<b>🗑️ SSH/OVPN ACCOUNT DELETED</b>
<b>━━━━━━━━━━━━━━━━━━</b>
<b>📋 Details:</b>
...
"
    ...
    # Send Telegram notification for failed deletion
    error_message="
<b>❌ SSH/OVPN ACCOUNT DELETION FAILED</b>
<b>━━━━━━━━━━━━━━━━━━</b>
<b>👤 Username :</b> <code>$user</code>
<b>🚫 Error :</b> <code>Failed to delete user account</code>
<b>🌐 Domain :</b> <code>$domain</code>
<b>🕐 Time :</b> <code>$(date '+%Y-%m-%d %H:%M:%S')</code>
<b>━━━━━━━━━━━━━━━━━━</b>
<b>⚠️ STATUS :</b> <b>DELETION FAILED</b>
"
