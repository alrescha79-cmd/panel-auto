...
dropbear_init_url="https://raw.githubusercontent.com/alrescha79-cmd/panel-auto/refs/heads/main/fodder/dropbear/dropbear"
dropbear_conf_url="https://raw.githubusercontent.com/alrescha79-cmd/panel-auto/refs/heads/main/fodder/examples/dropbear"
dropbear_dss_url="https://raw.githubusercontent.com/alrescha79-cmd/panel-auto/refs/heads/main/fodder/dropbear/dropbear_dss_host_key"
sshd_conf_url="https://raw.githubusercontent.com/alrescha79-cmd/panel-auto/refs/heads/main/fodder/examples/sshd"
banner_url="https://raw.githubusercontent.com/alrescha79-cmd/panel-auto/refs/heads/main/fodder/examples/banner"
common_password_url="https://raw.githubusercontent.com/alrescha79-cmd/panel-auto/refs/heads/main/fodder/examples/common-password"
ws_py_url="https://raw.githubusercontent.com/alrescha79-cmd/panel-auto/refs/heads/main/fodder/websocket/ws.py"
haproxy_cfg_url="https://raw.githubusercontent.com/alrescha79-cmd/panel-auto/refs/heads/main/fodder/Haproxy/haproxy.cfg"
xray_conf_url="https://raw.githubusercontent.com/alrescha79-cmd/panel-auto/refs/heads/main/fodder/nginx/xray.conf"
udp_url="https://raw.githubusercontent.com/alrescha79-cmd/panel-auto/refs/heads/main/fodder/udp/udp-custom-linux-amd64"
nginx_conf_url="https://raw.githubusercontent.com/alrescha79-cmd/panel-auto/refs/heads/main/fodder/nginx/nginx.conf"
badvpn_url="https://raw.githubusercontent.com/alrescha79-cmd/panel-auto/main/BadVPN-UDPWG/badvpn"
openvpn_url="https://raw.githubusercontent.com/alrescha79-cmd/panel-auto/refs/heads/main/fodder/openvpn/openvpn.zip"
gotop_url="https://raw.githubusercontent.com/alrescha79-cmd/panel-auto/refs/heads/main/gotop"
vmess_url="https://raw.githubusercontent.com/alrescha79-cmd/panel-auto/main/VMess-VLESS-Trojan+Websocket+gRPC/vmess/config.json"
vless_url="https://raw.githubusercontent.com/alrescha79-cmd/panel-auto/main/VMess-VLESS-Trojan+Websocket+gRPC/vless/config.json"
trojan_url="https://raw.githubusercontent.com/alrescha79-cmd/panel-auto/main/VMess-VLESS-Trojan+Websocket+gRPC/trojan/config.json"



shadowsocks_url="https://raw.githubusercontent.com/alrescha79-cmd/panel-auto/main/VMess-VLESS-Trojan+Websocket+gRPC/shadowsocks/config.json"
...
# Cek jika bukan root
if [ "$EUID" -ne 0 ]; then
    echo -e "${red}Harus menjalankan sebagai root untuk melanjutkan instalasi.${neutral}"
    exit 1
fi
# Update package list
if ! apt update -y; then
    echo -e "${red}Gagal memperbarui daftar paket.${neutral}"
fi

# Install sudo if not installed
if ! dpkg -s sudo >/dev/null 2>&1; then
    if ! apt install sudo -y; then
        echo -e "${red}Gagal menginstal sudo${neutral}"
    fi
else
    echo -e "${green}sudo sudah terinstal, melewati...${neutral}"
fi
...
if [ -n "$banner_url" ]; then
    wget -q -O /etc/Alrescha79.txt "$banner_url" && chmod +x /etc/Alrescha79.txt >/dev/null 2>&1 || echo -e "${red}Failed to download Alrescha79.txt${neutral}"
else
    echo -e "${yellow}banner_url is not set, skipping download of Alrescha79.txt${neutral}"
fi
...
wget --no-check-certificate -O /opt/bbr.sh https://raw.githubusercontent.com/alrescha79-cmd/panel-auto/refs/heads/main/bbr.sh
...
create_service "vmess" "Alrescha79 Server Xray Instance" "/usr/local/bin/xray run -config /etc/xray/vmess/%i.json"
create_service "vless" "Alrescha79 Server Xray Instance" "/usr/local/bin/xray run -config /etc/xray/vless/%i.json"
create_service "trojan" "Alrescha79 Server Xray Instance" "/usr/local/bin/xray run -config /etc/xray/trojan/%i.json"
create_service "shadowsocks" "Alrescha79 Server Shadowsocks Instance" "/usr/local/bin/xray run -config /etc/xray/shadowsocks/%i.json"
...
Documentation=https://t.me/Alrescha79
...
wget https://raw.githubusercontent.com/alrescha79-cmd/panel-auto/refs/heads/main/menu.sh && chmod +x menu.sh && ./menu.sh
...
wget https://raw.githubusercontent.com/alrescha79-cmd/panel-auto/refs/heads/main/package-gohide.sh && chmod +x package-gohide.sh && ./package-gohide.sh
cd 
...
# cd
# wget https://raw.githubusercontent.com/alrescha79-cmd/panel-auto/refs/heads/main/backend/install-go.sh && chmod +x install-go.sh && ./install-go.sh
# rm -rf install-go.sh
# cd
